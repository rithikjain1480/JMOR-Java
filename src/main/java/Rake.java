...
public class Rake {
    ...
    public LinkedHashMap<String, Double> calculateWordScores(String[] phrases) {
        LinkedHashMap<String, Integer> wordFrequencies = new LinkedHashMap<String, Integer>();
        LinkedHashMap<String, Integer> wordDegrees = new LinkedHashMap<String, Integer>();
        LinkedHashMap<String, Double> wordScores = new LinkedHashMap<String, Double>();
    ...
    public LinkedHashMap<String, Double> getCandidateKeywordScores(String[] phrases, LinkedHashMap<String, Double> wordScores) {
        LinkedHashMap<String, Double> keywordCandidates = new LinkedHashMap<String, Double>();
     ...
     * @return
     */
    public LinkedHashMap<String, Double> sortHashMap(LinkedHashMap<String, Double> map) {
